...
export default function Header({ title, subtitle }) {
  ...
  return (
    <div className="w-full min-h-screen md:py-40 md:min-h-full  relative backdrop-blur-3xl flex items-center justify-center md:px-5">
      <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 ml-52 md:ml-32 rounded-full w-80 h-80 md:w-40 md:h-40 bg-[#FF96D5]/50 dark:bg-[#FF96D5]/20 blur-[120px]"></div>
